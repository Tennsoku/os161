...
struct thread {
	...
	/*
	 * This is public because it isn't part of the thread system,
	 * and will need to be manipulated by the proc code.
	 */
	struct process *t_proc; // Process belongs to
 ...
 * code.
 * About proc: process to attach. If NULL, attach to current process.
 */
int
