...
struct lock {
	...
	// 0 for currently available for anyone to hold, 1
	// for currently on held by someone and unavailable
	volatile int in_use;
	// thread-specific var to define currently holder.
	struct thread *current_thr;
};
